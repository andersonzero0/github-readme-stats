...
//x="-38" y="-30" height="66" width="66" aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" data-testid="github-rank-icon"
const rankIcon = (rankIcon, rankLevel, percentile) => {
  switch (rankIcon) {
    case "linux":
      return `
        <svg viewBox="0 0 216 256" height="64" width="64" x="-38" y="-30" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <title>Tux</title>
          <defs id="tux_fx">
